...
local function loop()
 ...
 if visible then
  ...
  reaper.ImGui_SameLine(ctx); if reaper.ImGui_Button(ctx,"Chat leeren",130,bh) then chat_start=#history+1; info_visible=false end
